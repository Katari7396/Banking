...
const ProductCard = ({ id, href, imageSrc, altText, title }) => {
  return (
    <a id={`our-products-${id}`} href={href} className="product-card">
...
const ProductsSection = () => {
  const products = [
    ...
    },
    {
      ...
      imageSrc:
        "https://cdn2.mymoneymantra.com/Health_Insurance_22d7a5b405.webp",
      ...
      <div className="products-container">
        <div className="section-heading">
          <h2 className="heading-text">
            Bringing you the{" "}
            <span className="highlight-text">Best Products</span>
            <br className="desktop-only" />
            from Top Banks &amp; Financial{" "}
            <span className="institutions-text">Institutions</span>
